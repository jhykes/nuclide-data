...
for line in open(data_file):
    if line == '\n':
        nist_nuclide_raw_list.append(current_isotope)
        current_nuclide = []
    else:
...
nist_nuclides = {}
for isotope in nist_nuclide_processed_list:
...
def parse_one_wallet_line(line):
    ...
    d['branch fraction'] = do_if_present(line[34:41], process_branch)
